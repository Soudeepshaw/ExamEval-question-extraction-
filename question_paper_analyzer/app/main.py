...
async def startup_event():
    ...
    app_logger.info(f"Starting {settings.PROJECT_NAME} v2.0.0")
...
async def root():
    """Root endpoint"""
    return {
        "message": f"Welcome to {settings.PROJECT_NAME} v2.0.0",
        "description": "Advanced Question Paper Analysis with AI-powered content extraction",
        "version": "2.0.0",
        "docs": "/docs",
